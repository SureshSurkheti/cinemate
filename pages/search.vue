<template>
  <div>
    ...
    <section>
      <h1 v-if="movies.length" class="text-5xl font-extrabold dark:text-white">Movies Results</h1>
    ...
    <section>
      <h1 v-if="series.length" class="text-5xl font-extrabold dark:text-white">Series Results</h1>
      <ul class="grid grid-cols-5 gap">
